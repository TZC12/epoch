...
export interface RowProps {
  ...
  rightIcon?: ReactNode      /* 左侧 leading icon（图六白卡行形态） */
  chevron?: boolean
  onClick?: () => void
  className?: string
}
 ...
 */
export function Row({ title, sub, right, rightIcon, chevron, onClick, className = '' }: RowProps) {
  ...
  return (
    ...
    >
      {rightIcon && <span className="row__icon" aria-hidden="true">{rightIcon}</span>}
